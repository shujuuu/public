Swimm units and docs are saved on your repository in a directory named `.swm` as files with the `.swm` extension. </br> They are shared and synced with the rest of the team the same way that code is, using Git. 
</br> </br> 
